...
- [x] **B06 · P2 — Make saved content readable by screen readers.** Fact/date rows expose complete saved values, dates, known years, and age/anniversary details while retaining edit/delete actions. Both quick-add controls and Birthday/Include year switches have contextual labels. Verified native accessibility trees on iOS 18.0, iOS 26.5, and the physical Pixel 6 / Android 17; edit, accessible delete, and swipe-delete checks passed. VoiceOver/TalkBack speech navigation was not exercised.
